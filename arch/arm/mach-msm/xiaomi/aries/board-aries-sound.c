...
static void __init xiaomi_add_i2c_tpa2028d_devices(void)
{
...
int aries_console_stopped(void)
{
...
static struct fsa8008_platform_data xiaomi_hs_pdata = {
	.switch_name = "h2w",
